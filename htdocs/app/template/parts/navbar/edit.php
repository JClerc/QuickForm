          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="nav navbar-nav navbar-right">
                  <li><a href="/view/id/<?= $form->getId() ?>">Voir</a></li>

                  <li class="tooltip-nowrap"><a href="/stats/id/<?= $form->getId() ?>/" class="btn btn-round btn-default" data-toggle="tooltip" data-placement="bottom" data-title="Voir les statistiques" data-trigger="hover">Réponses</a></li>
               </ul>
